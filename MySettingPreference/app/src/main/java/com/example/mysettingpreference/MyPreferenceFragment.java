...
public class MyPreferenceFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private CheckBoxPreference isLoveStudyASPreference;
    ...
    private void init() {
        ...
        isLoveStudyASPreference = (CheckBoxPreference) findPreference(LOVE);
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(LOVE)) {
            isLoveStudyASPreference.setChecked(sharedPreferences.getBoolean(LOVE, false));
        }
    }
    ...
    private void setSummaries() {
        ...
        isLoveStudyASPreference.setChecked(sh.getBoolean(LOVE, false));
    }
}
