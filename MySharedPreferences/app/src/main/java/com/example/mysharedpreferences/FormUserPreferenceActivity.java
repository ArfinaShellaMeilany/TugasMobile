...
public class FormUserPreferenceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rgLoveMu = findViewById(R.id.rg_love_study_as);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_save) {
            ...
            String FIELD_REQUIRED = "Field tidak boleh kosong";
            ...
            if (!isValidEmail(email)) {
                String FIELD_IS_NOT_VALID = "Email tidak valid";
            ...
            if (!TextUtils.isDigitsOnly(phoneNo)) {
                String FIELD_DIGIT_ONLY = "Hanya boleh terisi numerik";
